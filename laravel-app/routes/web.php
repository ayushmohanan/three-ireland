...
Route::middleware(['auth'])->group(function (): void {
    ...
    Route::prefix('admin')->as('admin.')->group(function (): void {
        ...
        Route::get('/products/create', \App\Livewire\Admin\Products\CreateProducts::class)->name('products.create');
        Route::get('/products/{product}', \App\Livewire\Admin\Products\ViewProducts::class)->name('products.show');
        Route::get('/products/{product}/edit', \App\Livewire\Admin\Products\EditProducts::class)->name('products.edit');

        // Order
        Route::get('/order', \App\Livewire\Admin\ProductOrder::class)->name('order.index');
        Route::get('/orderlist', \App\Livewire\Admin\ProductOrderList::class)->name('orderlist.index');

        // customers

        Route::get('/customers', \App\Livewire\Admin\Customers::class)->name('customers.index');
        Route::get('/customers/create', \App\Livewire\Admin\Customers\CreateCustomer::class)->name('customers.create');
        Route::get('/customers/{customer}', \App\Livewire\Admin\Customers\ViewCustomer::class)->name('customers.show');
        Route::get('/customers/{customer}/edit', \App\Livewire\Admin\Customers\EditCustomer::class)->name('customers.edit');
