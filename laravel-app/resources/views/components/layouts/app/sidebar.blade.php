...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable
        ...
        <a href="{{ route('home') }}" class="mr-5 flex items-center space-x-2">
            <img src="{{ asset('images/logo.jpg') }}" alt="Threei Logo" height="100%" />
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group heading="Admin Managment" class="grid">
                @can('view users')
                ...
                @endcan
                @can('view roles')
                <flux:navlist.item icon="shield-user" :href="route('admin.roles.index')"
                    :current="request()->routeIs('admin.roles.*')">
                    {{ __('roles.title') }}
                </flux:navlist.item>
                @endcan
                @can('view permissions')
                <flux:navlist.item icon="shield-check" :href="route('admin.permissions.index')"
            ...
            <flux:navlist.group heading="Product Management" class="grid">
                @can('view customers')
                <flux:navlist.item icon="user" :href="route('admin.customers.index')"
            ...
            <flux:navlist.group class="grid">
                @can('view products')
                <flux:navlist.item icon="user" :href="route('admin.products.index')"
            ...
            <flux:navlist.group class="grid">
                @can('create order')
                <flux:navlist.item icon="user" :href="route('admin.order.index')"
                    :current="request()->routeIs('admin.order.*')">
                    Create Order
                </flux:navlist.item>
                @endcan
            </flux:navlist.group>
            ...
            <flux:navlist.group class="grid">
                @can('view orders')
                <flux:navlist.item icon="user" :href="route('admin.orderlist.index')"
                    :current="request()->routeIs('admin.orderlist.*')">
                    Order List
                </flux:navlist.item>
                @endcan
            </flux:navlist.group>
